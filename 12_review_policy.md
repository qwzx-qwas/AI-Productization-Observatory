...
- 不是所有 review 结果都自动入训练池
- 只有高质量、裁决清晰、证据充分的样本才建议进入训练池

## 12. 当前待人工确认项

- 谁能 override taxonomy / score / merge
- unresolved 是否阻塞主报表
- review 结果是否自动进入训练池
