...
- file=`docs/phase1_a_baseline.md` / source_decisions=`DEC-029` / task4_action=`verify_or_update_note` / task4_note=`Keep the baseline narrative aligned with the signed GitHub-live/Product-Hunt-deferred exit boundary and the three-stage audit workflow.`
...
- file=`docs/phase1_g_acceptance_evidence.md` / source_decisions=`DEC-029` / task4_action=`verify_or_update_note` / task4_note=`Keep the Phase1-G evidence package aligned with the signed machine_pre_audit -> human_sampled_verdict -> owner_signoff workflow and the deferred Product Hunt exit-gate scope.`
