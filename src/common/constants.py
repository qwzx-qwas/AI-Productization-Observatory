...
DEFAULT_GOLD_SET_DIR = Path("gold_set")
DEFAULT_CANDIDATE_WORKSPACE_DIR = Path("docs/candidate_prescreen_workspace")
DEFAULT_GOLD_SET_STAGING_DIR = Path("docs/gold_set_300_real_asset_staging")
